...
logger.info("torun - Finish to insert into activityinday " + daytime);
	...
	public HashMap getgate(long daytime)
	{
		...
		gatemap.put("east", new GateCount("0C8268F9314E", "0C8268F15C64"));  //学29
		gatemap.put("middle", new GateCount("14E4E6E14460", "14E6E4E142A8"));//教3
		gatemap.put("north", new GateCount("0C8268C7D504", "0C8268F90E64"));//学10南门
...
logger.info("end to getgelin" + re_time);
	...
	public static void main(String args[])
	{
		try {
			...
			if (args[3].equals("yesterday")) { // yesterday表示只处理昨天的，20140711表示只处理该天的数据
				day = ti.getYestoday();
			} else {
				day = args[3];
			}
